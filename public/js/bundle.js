...
var showAlert = function showAlert(type, msg) {
  ...
  var clickHideAlert = document.getElementById('hideAlertNotification');
  var ViewAlert = document.getElementById("alert-notification");
  if (clickHideAlert) clickHideAlert.addEventListener('click', function () {
    ViewAlert.style.display = 'none';
  });
};
...
var createProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productName, price, stock, additionalInfo, delInfo, discount, colours, sizes, promoQtyPrice, FbId, currency, value, conversionEvent, thankYouPage, submitBtnText, submitBtnBGColor, submitBtnColor, submitButton) {
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                formStyle: {
                  ...
                  submitBtnBGColor: submitBtnBGColor,
  ...
  return function createProduct(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15, _x16, _x17, _x18) {
...
exports.updateSchedule = exports.updateDelivery = exports.updateProduct = exports.cloneProductApi = exports.updateProcessOrder = exports.updateCancelOrder = exports.updateShippingOrder = exports.updateOrderEmails = exports.updateTags = exports.updatePixel = void 0;
...
var updatePixel = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(facebookPixelId, facebookCurrency, facebookValue, submitButton) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                facebookCurrency: facebookCurrency,
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            (0, _index.stopLoadingBtnSpinner)(submitButton);
            (0, _alert.showAlert)('success', 'Something is wrong somewhere. Try again later');
  ...
  return function updatePixel(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateTags = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(tags, orderId, submitButton) {
    var res, _tags, pOrdertags, tagsForm;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _index.stopLoadingBtnSpinner)(submitButton);
              _tags = res.data.data.Updatedorder.tags;
              pOrdertags = submitButton.closest('td').querySelector('.p-order-tags');
              tagsForm = submitButton.closest('form');
              pOrdertags.style.display = 'block';
              tagsForm.style.display = 'none';
              pOrdertags.innerText = _tags;
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Unable to update tags. Try again');
  ...
  return function updateTags(_x5, _x6, _x7) {
...
var updateOrderEmails = /*#__PURE__*/function () {
  ...
  return function updateOrderEmails(_x8) {
...
var updateShippingOrder = /*#__PURE__*/function () {
  ...
  return function updateShippingOrder(_x9, _x10, _x11) {
...
var updateCancelOrder = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(OrderId, target) {
    var res, tda, icon;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/orders/cancel/".concat(OrderId),
              data: {
                OrderId: OrderId
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Order has been marked as Canceled');
              tda = target.closest('tr').querySelector('a.order_status_text');
              tda.innerText = 'Canceled';
              icon = target.closest('tr').querySelector('td i');
  ...
  return function updateCancelOrder(_x12, _x13) {
    return _ref5.apply(this, arguments);
  };
}();

exports.updateCancelOrder = updateCancelOrder;

var updateProcessOrder = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(OrderId, target) {
    var res, tda, icon;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/orders/process/".concat(OrderId),
              data: {
                OrderId: OrderId
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Order has been marked as Processed');
              tda = target.closest('tr').querySelector('a.order_status_text');
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Opps! Unable to update order. Try again later. If the error persist, kindly contact us ASAP');
            if (_context6.t0.response) console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context6.t0.response.data.message));else console.log(_context6.t0);
  ...
  return function updateProcessOrder(_x14, _x15) {
    return _ref6.apply(this, arguments);
  };
}();

exports.updateProcessOrder = updateProcessOrder;

var cloneProductApi = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/products/clone/".concat(productId)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Product Duplicated!');
              location.reload();
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Opps! Unable to Duplicate product. Try again later. If the error persist, kindly contact us ASAP');
  ...
  return function cloneProductApi(_x16) {
    return _ref7.apply(this, arguments);
  };
}();

exports.cloneProductApi = cloneProductApi;

var updateProduct = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(productName, price, stock, additionalInfo, delInfo, discount, colours, sizes, promoQtyPrice, FbId, currency, value, conversionEvent, thankYouPage, submitBtnText, submitBtnBGColor, submitBtnColor, productId, submitButton) {
  ...
  return function updateProduct(_x17, _x18, _x19, _x20, _x21, _x22, _x23, _x24, _x25, _x26, _x27, _x28, _x29, _x30, _x31, _x32, _x33, _x34, _x35) {
...
var updateDelivery = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(DelOrderId) {
    var res;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/orders/deliver/".concat(DelOrderId)
            });
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Opps! Unable to update order. Try again later. If the error persist, kindly contact us ASAP');
            console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context9.t0.response.data.message));
  ...
  return function updateDelivery(_x36) {
...
var updateSchedule = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(schOrderId, scheduledAt, submitButton, target) {
    var res, tda, icon;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/orders/schedule/".concat(schOrderId),
              data: {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Order has been Scheduled');
              (0, _index.stopLoadingBtnSpinner)(submitButton);
          ...
          case 7:
            ...
            (0, _index.stopLoadingBtnSpinner)(submitButton);
            (0, _alert.showAlert)('error', 'Opps! Unable to update order. Try again later. If the error persist, kindly contact us ASAP');
            if (_context10.t0.response) console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context10.t0.response.data.message));else console.log(_context10.t0);
  ...
  return function updateSchedule(_x37, _x38, _x39, _x40) {
...
/* eslint-disable */
var createProductInput = function createProductInput(e, submitButton) {
  e.preventDefault();
  var productName = document.getElementById('productName').value;
  var price = document.getElementById('productPrice').value || 0;
  var stock = document.getElementById('productStock').value;
  var additionalInfo = document.getElementById('additionalInfo').value;
  var delInfo = document.getElementById('product-del-Info').value;
  ...
  var submitBtnTextColor = document.getElementById('submitBtnTextColor').value;
  var submitBtnBGColor = document.getElementById('submitBtnBGColor').value;
  var submitBtnTextInput = document.getElementById('submitbBtnTextInput').value;
  var promoPriceForm = document.getElementById('promoPriceForm').querySelectorAll('.QPInputcl');
  var newarray = [];
  promoPriceForm.forEach(function (e) {
    var inputtext = e.querySelector('input[type="text"]').value;
    var inputnumber = e.querySelector('input[type="number"]').value;
    var array = "".concat(inputtext, " = \u20A6").concat(inputnumber);
    newarray.push(array);
  });
  var promoPriceQty = newarray.toString();
  var facebookPixelId = document.getElementById('product-pixel-id').value;
  var facebookPixelEvent = document.getElementById('product-pixel-conversion').value;
  var facebookCurrency = document.getElementById('product-pixel-currency').value;
  var facebookValue = document.getElementById('product-pixel-value').value;
  var thankYouPage = document.getElementById('product-thank-you-page').value;
  ...
  if (price > 0 && promoPriceQty.split(',')[0] != ' = ₦') {
    ...
    return false;
  } else (0, _index.loadingBtnSpinner)(submitButton);

  (0, _create.createProduct)(productName, price, stock, additionalInfo, delInfo, discount, colours, sizes, promoPriceQty, facebookPixelId, facebookCurrency, facebookValue, facebookPixelEvent, thankYouPage, submitBtnTextInput, submitBtnBGColor, submitBtnTextColor, submitButton);
};

exports.createProductInput = createProductInput;

var editProductInput = function editProductInput(e, submitButton) {
  e.preventDefault();
  var productName = document.getElementById('editproductName').value;
  var editprice = document.getElementById('editProductPrice').value || 0;
  ...
  var delInfo = document.getElementById('edit-product-del-Info').value;
  ...
  var promoPriceQty = newarray.toString();
  var facebookPixelId = document.getElementById('edit-product-pixel-id').value;
  var facebookPixelEvent = document.getElementById('edit-product-pixel-conversion').value;
  var facebookCurrency = document.getElementById('edit-product-pixel-currency').value;
  var facebookValue = document.getElementById('edit-product-pixel-value').value;
  console.log(facebookValue);
  var thankYouPage = document.getElementById('edit-product-thank-you-page').value;
  ...
  (0, _update.updateProduct)(productName, editprice, stock, additionalInfo, delInfo, discount, colours, sizes, promoPriceQty, facebookPixelId, facebookCurrency, facebookValue, facebookPixelEvent, thankYouPage, submitBtnTextInput, submitBtnBGColor, submitBtnTextColor, productId, submitButton);
};

exports.editProductInput = editProductInput;
},{"./create":"create.js","./update":"update.js","./index":"index.js"}],"loginAPI.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.busLogout = exports.busLogin = void 0;
...
var busLogin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(businessEmail, businessPassword, submitButton) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function busLogin(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"updateBankAccount.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.accountNamepaystackLookup = exports.account_Lookup_UpdateBankAccount = void 0;
...
var updateBusBankAccount = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(bankName, accountNumber, bankCode, bankAccountName) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Bank Account Linked!');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function updateBusBankAccount(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();

var account_Lookup_UpdateBankAccount = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(accountNumber, bank_id, bankName) {
    var res, resAccountName, resAccNum, resBankId;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              url: "https://api.paystack.co/bank/resolve?account_number=".concat(accountNumber, "&bank_code=").concat(bank_id),
              headers: {
          ...
          case 3:
            ...
            if (res.data.status === true) {
              resAccountName = res.data.data.account_name;
              resAccNum = res.data.data.account_number;
              resBankId = res.data.data.bank_id;
  ...
  return function account_Lookup_UpdateBankAccount(_x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();

exports.account_Lookup_UpdateBankAccount = account_Lookup_UpdateBankAccount;

var accountNamepaystackLookup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(accountNumber, bank_id, accountNameDisplayEL, saveBtn) {
    var res, resAccountName, resMessage;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
          ...
          case 7:
            ...
            if (_context3.t0.response) {
              resMessage = _context3.t0.response.data.message;

              if (resMessage === 'bank_code is required') {
                accountNameDisplayEL.innerHTML = 'Kindly pick a bank name and retype the account number';
              } else if (resMessage === 'Could not resolve account name. Check parameters or try again.') {
                accountNameDisplayEL.innerHTML = 'Could not get your account name right now. Double check your account number and bank and try again';
              } else {
              ...
              accountNameDisplayEL.innerHTML = 'Something went wrong. Reload and try again';
            }
  ...
  return function accountNamepaystackLookup(_x8, _x9, _x10, _x11) {
    return _ref3.apply(this, arguments);
  };
}();

exports.accountNamepaystackLookup = accountNamepaystackLookup;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"signupAPI.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeBusMember = exports.addNewBus = exports.busSendVerifyEmail = exports.busResetPassword = exports.busForgotPassword = exports.busSignup = void 0;
...
var busSignup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(businessName, fullName, businessEmail, businessPhoneNumber, businessPassword, submitButton) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function busSignup(_x, _x2, _x3, _x4, _x5, _x6) {
    return _ref.apply(this, arguments);
  };
}();
...
var busForgotPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(businessEmail) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function busForgotPassword(_x7) {
    return _ref2.apply(this, arguments);
  };
}();
...
var busResetPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(businessPassword, busToken) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/businessUsers/resetPassword/".concat(busToken),
              data: {
                businessPassword: businessPassword
              }
            });
  ...
  return function busResetPassword(_x8, _x9) {
    return _ref3.apply(this, arguments);
  };
}();
...
var busSendVerifyEmail = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(businessUserId) {
    var res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/businessUsers/sendverifyemail/".concat(businessUserId)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Verify Email Sent");
            }
          ...
          case 7:
            _context4.prev = 7;
            _context4.t0 = _context4["catch"](0);
            (0, _alert.showAlert)('error', 'Unable to Send Email. Kindly Retry');
  ...
  return function busSendVerifyEmail(_x10) {
    return _ref4.apply(this, arguments);
  };
}();

exports.busSendVerifyEmail = busSendVerifyEmail;

var addNewBus = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(fullName, businessEmail, businessPassword, role, submitButton) {
    var res;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
  ...
  return function addNewBus(_x11, _x12, _x13, _x14, _x15) {
    return _ref5.apply(this, arguments);
  };
}();

exports.addNewBus = addNewBus;

var removeBusMember = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(remove_businessID) {
    var res;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/businessUsers/delete/".concat(remove_businessID)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Member Removed");
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
          ...
          case 7:
            _context6.prev = 7;
            _context6.t0 = _context6["catch"](0);
            (0, _alert.showAlert)('error', 'Unable remove Member. Kindly Retry');
  ...
  return function removeBusMember(_x16) {
    return _ref6.apply(this, arguments);
  };
}();

exports.removeBusMember = removeBusMember;
...
exports.busLoginInput = exports.addNewbusInput = exports.busSignupInput = void 0;
...
/* eslint-disable */
var busSignupInput = function busSignupInput(e, submitButton) {
  e.preventDefault();
  var businessName = document.getElementById('input-bus-name').value;
  var fullName = document.getElementById('input-bus-fullname').value;
  ...
  (0, _signupAPI.busSignup)(businessName, fullName, businessEmail, businessPhoneNumber, businessPassword, submitButton);
};

exports.busSignupInput = busSignupInput;

var addNewbusInput = function addNewbusInput(e, submitButton) {
  e.preventDefault();
  var fullName = document.getElementById('input-new-staff-fullname').value;
  var businessEmail = document.getElementById('input-new-staff-emailAddress').value;
  var businessPassword = document.getElementById('input-new-staff-password').value;
  var role = document.getElementById('input-new-staff-role').value;
  (0, _index.loadingBtnSpinner)(submitButton);
  (0, _signupAPI.addNewBus)(fullName, businessEmail, businessPassword, role, submitButton);
};

exports.addNewbusInput = addNewbusInput;

var busLoginInput = function busLoginInput(e, submitButton) {
  e.preventDefault();
  ...
  (0, _index.loadingBtnSpinner)(submitButton);
  (0, _loginAPI.busLogin)(businsessEmail, busisnessPassword, submitButton);
};

exports.busLoginInput = busLoginInput;
},{"./signupAPI":"signupAPI.js","./loginAPI":"loginAPI.js","./index":"index.js"}],"forgot_resetPass.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.busResetPassInput = exports.busForgotPassInput = void 0;
...
var busResetPassInput = function busResetPassInput(e) {
  ...
  } else (0, _signupAPI.busResetPassword)(businessPassword, busToken);
};

exports.busResetPassInput = busResetPassInput;
},{"./signupAPI":"signupAPI.js"}],"salesTransAPI.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.transLifeTime = exports.transThisMonth = exports.transThisWeek = exports.transToday = exports.salesLifeTime = exports.salesThisMonth = exports.salesThisWeek = exports.salesToday = void 0;
...
var salesToday = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/salestoday?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              todayResult = res.data.data.sumOfCartSalesToday;
              _index.sumOfSalesResult.innerHTML = "\u20A6 ".concat(todayResult);
              (0, _index.hideSalesLoading)();
            }
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            (0, _index.hideSalesLoading)();
            (0, _alert.showAlert)('error', 'Unable to check this right now. Try again Later');
  ...
  return function salesToday(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.salesToday = salesToday;

var salesThisWeek = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(productId) {
    var url, res, weeklyResult;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/salesWeek?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              weeklyResult = res.data.data.sumOfCartSalesWeek;
              _index.sumOfSalesResult.innerHTML = "\u20A6 ".concat(weeklyResult);
              (0, _index.hideSalesLoading)();
            }
  ...
  return function salesThisWeek(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.salesThisWeek = salesThisWeek;

var salesThisMonth = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(productId) {
    var url, res, monthlyResult;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/salesmonth?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              monthlyResult = res.data.data.sumOfCartSalesMonth;
              _index.sumOfSalesResult.innerHTML = "\u20A6 ".concat(monthlyResult);
              (0, _index.hideSalesLoading)();
            }
  ...
  return function salesThisMonth(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.salesThisMonth = salesThisMonth;

var salesLifeTime = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(productId) {
    var url, res, lifeTimeResult;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/saleslifetime?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              lifeTimeResult = res.data.data.sumOfCartSalesLifeTime;
              _index.sumOfSalesResult.innerHTML = "\u20A6 ".concat(lifeTimeResult);
              (0, _index.hideSalesLoading)();
            }
  ...
  return function salesLifeTime(_x4) {
    return _ref4.apply(this, arguments);
  };
}(); //TRANSACTIONS


exports.salesLifeTime = salesLifeTime;

var transToday = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(productId) {
    var url, res, transTodayResult;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/transtoday?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              transTodayResult = res.data.data.sumOfTransToday;
              _index.sumOfTransResult.innerHTML = "\u20A6 ".concat(transTodayResult);
              (0, _index.hideTransLoading)();
            }
  ...
  return function transToday(_x5) {
    return _ref5.apply(this, arguments);
  };
}();

exports.transToday = transToday;

var transThisWeek = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(productId) {
    var url, res, transWeekResult;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/transweek?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              transWeekResult = res.data.data.sumOfTransWeek;
              _index.sumOfTransResult.innerHTML = "\u20A6 ".concat(transWeekResult);
              (0, _index.hideTransLoading)();
            }
  ...
  return function transThisWeek(_x6) {
    return _ref6.apply(this, arguments);
  };
}();

exports.transThisWeek = transThisWeek;

var transThisMonth = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(productId) {
    var url, res, transMonthResult;
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/transmonth?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              transMonthResult = res.data.data.sumOfTransMonth;
              _index.sumOfTransResult.innerHTML = "\u20A6 ".concat(transMonthResult);
              (0, _index.hideTransLoading)();
            }
  ...
  return function transThisMonth(_x7) {
    return _ref7.apply(this, arguments);
  };
}();

exports.transThisMonth = transThisMonth;

var transLifeTime = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(productId) {
    var url, res, transLifeTimeResult;
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            if (productId) {
              url = "/api/v1/orders/translifetime?productId=".concat(productId);
            } else {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              transLifeTimeResult = res.data.data.sumOfTransLifeTime;
              _index.sumOfTransResult.innerHTML = "\u20A6 ".concat(transLifeTimeResult);
              (0, _index.hideTransLoading)();
            }
  ...
  return function transLifeTime(_x8) {
    return _ref8.apply(this, arguments);
  };
}();

exports.transLifeTime = transLifeTime;
...
exports.hideTransLoading = exports.hideSalesLoading = exports.hideLoadingAnimation = exports.remove_member_businessID = exports.sumOfTransResult = exports.sumOfSalesResult = void 0;
...
var _updateBankAccount = require("./updateBankAccount");
...
var _salesTransAPI = require("./salesTransAPI");

var sumOfSalesResult = document.getElementById('sumOfSalesResult');
...
var addNewBusForm = document.querySelector('.add-new-member-form');
...
var updateScheduleForm = document.querySelector('.schedule-order-form');
var business_pixel_Form = document.getElementById('business-pixel-form');
var tagsForm = document.getElementById('tagsform');
var bankAccountForm = document.getElementById('businessAccount-bank-form');
...
var remove_member_ID = (document.getElementById('remove-member-businessID') || {}).value;
var remove_member_btn = document.querySelector(".remove-member-form");
...
var request_Verify_Email_btn = document.getElementById('request-verify-email_btn');
if (request_Verify_Email_btn) request_Verify_Email_btn.addEventListener('click', function (e) {
  var BusinessUserId = e.target.dataset.userid;
  (0, _signupAPI.busSendVerifyEmail)(BusinessUserId);
});
var loading_Animation = document.getElementById('loading-animation');

function displayLoadingAnimation() {
  loading_Animation.classList.add('display'); // to stop loading after some time
...
var hideLoadingAnimation = function hideLoading() {
  loading_Animation.classList.remove('display');
};
...
var salesLoader = document.getElementById('loading-Sales-Result');
var salesToday_btn = document.getElementById('salesToday_btn');
var salesWeekly_btn = document.getElementById('salesWeekly_btn');
var salesMonthly_btn = document.getElementById('salesMonthly_btn');
var salesLifeTime_btn = document.getElementById('salesLifeTime_btn');

function displaySalesLoading() {
  salesLoader.classList.add('display'); // to stop loading after some time
...
var hideSalesLoading = function hideLoading() {
  salesLoader.classList.remove('display');
};

exports.hideSalesLoading = hideSalesLoading;
if (salesToday_btn) salesToday_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');

  if (product) {
    var productId = product.dataset.productid;
  }

  displaySalesLoading(), (0, _salesTransAPI.salesToday)(productId);
});
if (salesWeekly_btn) salesWeekly_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');
  ...
  displaySalesLoading(), (0, _salesTransAPI.salesThisWeek)(productId);
});
if (salesMonthly_btn) salesMonthly_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');
  ...
  displaySalesLoading(), (0, _salesTransAPI.salesThisMonth)(productId);
});
if (salesLifeTime_btn) salesLifeTime_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');
  ...
  displaySalesLoading(), (0, _salesTransAPI.salesLifeTime)(productId);
}); //Transactions

var drpdown = document.getElementById('salesTransDropdown');
var transLoader = document.getElementById('loading-Trans-Result');
var transToday_btn = document.getElementById('transToday_btn');
var transWeekly_btn = document.getElementById('transWeekly_btn');
var transMonthly_btn = document.getElementById('transMonthly_btn');
var transLifeTime_btn = document.getElementById('transLifeTime_btn');

function displayTransLoading() {
  transLoader.classList.add('display'); // to stop loading after some time
...
var hideTransLoading = function hideLoading() {
  transLoader.classList.remove('display');
};

exports.hideTransLoading = hideTransLoading;
if (transToday_btn) transToday_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');
  ...
  displayTransLoading(), (0, _salesTransAPI.transToday)(productId);
});
if (transWeekly_btn) transWeekly_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');
  ...
  displayTransLoading(), (0, _salesTransAPI.transThisWeek)(productId);
});
if (transMonthly_btn) transMonthly_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');
  ...
  displayTransLoading(), (0, _salesTransAPI.transThisMonth)(productId);
});
if (transLifeTime_btn) transLifeTime_btn.addEventListener('click', function () {
  var product = transToday_btn.closest('.salesTransSection');
  ...
  displayTransLoading(), (0, _salesTransAPI.transLifeTime)(productId);
});
if (remove_member_btn) remove_member_btn.addEventListener('submit', function () {
  console.log(document.getElementById('remove-member-businessID').value);
  console.log('Got it');
});

function removeMemberFuction(id) {
  var remove_businessId = id;
  (0, _signupAPI.removeBusMember)(remove_businessId);
}
...
if (busloginForm) busloginForm.addEventListener('submit', function (e) {
  ...
  (0, _signup_login.busLoginInput)(e, submitButton);
});
...
if (busSignupForm) busSignupForm.addEventListener('submit', function (e) {
  ...
  (0, _signup_login.busSignupInput)(e, submitButton);
});
if (addNewBusForm) addNewBusForm.addEventListener('submit', function (e) {
  var submitButton = addNewBusForm.querySelector('[type="submit"]');
  (0, _signup_login.addNewbusInput)(e, submitButton);
});
...
if (createProductForm) createProductForm.addEventListener('submit', function (e) {
  ...
  (0, _product.createProductInput)(e, submitButton);
});
if (editProductForm) editProductForm.addEventListener('submit', function (e) {
  ...
  (0, _product.editProductInput)(e, submitButton);
});
if (business_pixel_Form) business_pixel_Form.addEventListener('submit', function (e) {
  e.preventDefault();
  var submitButton = business_pixel_Form.querySelector('[type="submit"]');
  loadingBtnSpinner(submitButton);
  var facebookPixelId = document.getElementById('business-pixelId').value;
  var facebookPixelCurrency = document.getElementById('business-pixel-currency').value;
  var facebookPixelValue = document.getElementById('business-pixel-value').value;
  (0, _update.updatePixel)(facebookPixelId, facebookPixelCurrency, facebookPixelValue, submitButton);
});
var inputAccountNumber = document.getElementById('account_number_businessAccount');
if (inputAccountNumber) inputAccountNumber.addEventListener('blur', function () {
  var account_number = inputAccountNumber.value;
  var bankIdOptions = document.getElementById('bank_code_businessAccount');
  var saveBankDetailsbtn = document.getElementById('save-bank-details-btn');
  var accountNameDisplay = document.getElementById('business-accountNumber-result');
  accountNameDisplay.innerHTML = '';
  displayLoadingAnimation();
  var bankId = bankIdOptions.value;
  (0, _updateBankAccount.accountNamepaystackLookup)(account_number, bankId, accountNameDisplay, saveBankDetailsbtn);
});
if (bankAccountForm) bankAccountForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var accountNumber = document.getElementById('account_number_businessAccount').value;
  var bankIdOptions = document.getElementById('bank_code_businessAccount');
  var bankId = bankIdOptions.value;
  var bankName = bankIdOptions.options[bankIdOptions.selectedIndex].text;
  (0, _updateBankAccount.account_Lookup_UpdateBankAccount)(accountNumber, bankId, bankName);
});
if (tagsForm) tagsForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var tags = document.getElementById('order-tags').value;
  var orderId = document.getElementById('orderid').value;
  var submitButton = tagsForm.querySelector('[type="submit"]');
  loadingBtnSpinner(submitButton);
  (0, _update.updateTags)(tags, orderId, submitButton);
});
$('.create-tags-pencil').on('click', function (e) {
  var target = e.target || e.srcElement;
  var pencilIcon = target.closest('td').querySelector('.allorders-tags-form');
  var pOrderTags = target.closest('td').querySelector('.p-order-tags');
  pOrderTags.style.display = 'none';
  pencilIcon.style.display = 'block';
});
$('.cancel-tags-form').on('click', function (e) {
  var target = e.target || e.srcElement;
  var cancelBtn = target.closest('form');
  var pOrdertags = target.closest('section').querySelector('.p-order-tags');
  pOrdertags.style.display = 'block';
  cancelBtn.style.display = 'none';
});
$('.allorders-tags-form').on('submit', function (e) {
  e.preventDefault();
  var target = e.target || e.srcElement;
  var orderId = target.dataset.orderid;
  var tags = target.parentNode.querySelector(".input-order-tags").value;
  var submitButton = target.querySelector('[type="submit"]');
  loadingBtnSpinner(submitButton);
  (0, _update.updateTags)(tags, orderId, submitButton);
});
$('.mobileOrders-tags-form').on('submit', function (e) {
  e.preventDefault();
  var orderId = e.target.dataset.orderid;
  var tags = document.getElementById("input-order-tags-".concat(orderId)).value; // console.log($(this));
...
$('.suggested-tag-input').on('click', function (e) {
  var suggestedText = e.target.innerText;
  var inputOrderTags = e.target.closest('form').querySelector('.input-order-tags');
...
$('.cancel-mobile-order').on('click', function (e) {
  ...
  var target = e.target || e.srcElement;
  var orderId = target.dataset.orderid;
  var orderName = target.dataset.name;

  if (confirm("Are you sure you want to cancel ".concat(orderName, "'s order? Click Ok to confirm"))) {
    (0, _alert.showAlert)('success', 'Processing...');
    (0, _update.updateCancelOrder)(orderId, target);
  } else {
    return false;
  }
});
$('.processed-mobile-order').on('click', function (e) {
  ...
  if (confirm("Are you sure you've processed ".concat(orderName, "'s order? Click Ok to confirm"))) {
    (0, _alert.showAlert)('success', 'Processing...');
    (0, _update.updateProcessOrder)(orderId, target);
  } else {
    return false;
  }
});
$('.add-tag-mobile-button').on('click', function (e) {
  e.preventDefault();
  var target = e.target || e.srcElement;
  var orderFormMobile = target.closest('section').querySelector('.allorders-tags-form');
  var pMobileTags = target.closest('section').querySelector('.p-order-tags');
...
if (updateDeliveryForm) updateDeliveryForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var delOrderId = document.getElementById('orderid').value;
  (0, _update.updateDelivery)(delOrderId);
});
$('.schedule-modal-button').on('click', function (e) {
  var target = e.target;
  var schOrderId = $(this).data('orderid');
  if (updateScheduleForm) updateScheduleForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var submitButton = updateScheduleForm.querySelector('[type="submit"]');
    var schDate = document.getElementById('schedule-date-input').value;
    var scheduleDate = "".concat(schDate, "T00:00:00.000+00:00");
    loadingBtnSpinner(submitButton);
    (0, _update.updateSchedule)(schOrderId, scheduleDate, submitButton, target);
  });
});
...
var cloneQPbtn = document.getElementById('cloneQPBtn');
if (cloneQPbtn) cloneQPbtn.addEventListener('click', function (e) {
  var allPromoInput = document.querySelectorAll('.QPInputcl');
  var i = allPromoInput.length;
  var original = allPromoInput[allPromoInput.length - 1];
  var clone = original.cloneNode(true, true);
  var newNumber = ++i;
  var qtyInput = clone.querySelector('input[type="text"]');
  var priceInput = clone.querySelector('input[type="number"]');
  qtyInput.setAttribute('placeholder', "Quantity ".concat(newNumber));
  priceInput.setAttribute('placeholder', "Price ".concat(newNumber));
  original.parentNode.insertBefore(clone, cloneQPbtn);
});
var submittextInputSample = document.getElementById('submitbBtnTextInput');

if (submittextInputSample) {
  submittextInputSample.addEventListener('input', function (e) {
    changeSubmitBtnText(e);
  });
  submittextInputSample.addEventListener('change', function (e) {
    changeSubmitBtnText(e);
  });
}

function changeSubmitBtnText(e) {
  var submitBtn = document.getElementById('submitBtnSample');
  var target = e.target || e.srcElement;
  submitBtn.value = target.value;
}

var submitBGColorSample = document.getElementById('submitBtnBGColor');

if (submitBGColorSample) {
  submitBGColorSample.addEventListener('input', function (e) {
    changeSubmitBGColor(e);
  });
  submitBGColorSample.addEventListener('change', function (e) {
    changeSubmitBGColor(e);
  });
}
...
var submitBtnTextColor = document.getElementById('submitBtnTextColor');

if (submitBtnTextColor) {
  submitBtnTextColor.addEventListener('input', function (e) {
    changeSubmitTextColor(e);
  });
  submitBtnTextColor.addEventListener('change', function (e) {
    changeSubmitTextColor(e);
  });
}
...
$('.cloneProduct').on('click', function (e) {
  ...
  (0, _update.cloneProductApi)(productId);
