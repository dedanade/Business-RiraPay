...
})(
  {
      ...
      function (require, module, exports) {
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 7:
                        ...
                        (0, _alert.showAlert)(
                          'success',
                          'Something is wrong somewhere. Try again later'
                        );
        ...
        var updateTags = /*#__PURE__*/ (function () {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(tags) {
              var res;
              return regeneratorRuntime.wrap(
        ...
        var updateOrderEmails = /*#__PURE__*/ (function () {
          var _ref3 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(orders) {
              var res;
              return regeneratorRuntime.wrap(
                  ...
                  while (1) {
                    switch ((_context5.prev = _context5.next)) {
                      ...
                      case 9:
                        ...
                        console.log(
                          '\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 '.concat(
                            _context5.t0.response.data.message
                          )
                        );
                  ...
                  while (1) {
                    switch ((_context6.prev = _context6.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/deliver/'.concat(
                            _index.DelOrderId
                          ),
                          data: {
                      ...
                      case 7:
                        ...
                        console.log(
                          '\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 '.concat(
                            _context6.t0.response.data.message
                          )
                        );
    ...
    'product.js': [
      function (require, module, exports) {
        ...
        var createProductInput = function createProductInput(e) {
          ...
          var facebookPixelId = document.getElementById('product-pixel-id')
            .value;
          var facebookCurrency = document.getElementById(
            'product-pixel-currency'
          ).value;
          var facebookValue = document.getElementById('product-pixel-value')
            .value;
          var promoPriceQty = ''
            .concat(promoQty, ' = ')
            .concat(promoPrice, ' Naira, ')
            .concat(promoQty2, ' = ')
            .concat(promoPrice2, ' Naira, ')
            .concat(promoQty3, ' = ')
            .concat(promoPrice3, ' Naira, ')
            .concat(promoQty4, ' = ')
            .concat(promoPrice4, ' Naira');
          ...
          if (price > 0 && promoPriceQty.split(',')[0] != '0 = 0 Naira') {
            ...
            price === 0 &&
            promoPriceQty.split(',')[0] === '0 = 0 Naira'
          ) {
            alert(
              "Kindly use one of the pricing type. The two options can't be empty"
            );
          } else
            (0, _create.createProduct)(
              productName,
              price,
              stock,
              additionalInfo,
        ...
        var editProductInput = function editProductInput(e) {
          ...
          var additionalInfo = document.getElementById('editadditionalInfo')
            .value;
          ...
          var promoPrice2 =
            document.getElementById('editPromoPrice2').value || 0;
          var promoQty3 = document.getElementById('editPromoQty3').value || 0;
          var promoPrice3 =
            document.getElementById('editPromoPrice3').value || 0;
          var promoQty4 = document.getElementById('editPromoQty4').value || 0;
          var promoPrice4 =
            document.getElementById('editPromoPrice4').value || 0;
          var promoPriceQty = ''
            .concat(promoQty, ' = ')
            .concat(promoPrice, ' Naira, ')
            .concat(promoQty2, ' = ')
            ...
            .concat(promoQty4, ' = ')
            .concat(promoPrice4, ' Naira');
          var facebookPixelId = document.getElementById('edit-product-pixel-id')
            .value;
          var facebookCurrency = document.getElementById(
            'edit-product-pixel-currency'
          ).value;
          var facebookValue = document.getElementById(
            'edit-product-pixel-value'
          ).value;
          var editCodOptionCheckbox = document.getElementById(
      ...
      { './create': 'create.js', './update': 'update.js' },
    ],
    'loginAPI.js': [
      function (require, module, exports) {
        'use strict';
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 7:
                        ...
                        (0, _alert.showAlert)(
                          'error',
                          'Unable to Log out right now. Try again later'
                        );
    ...
    'signupAPI.js': [
      function (require, module, exports) {
        ...
        exports.busSendVerifyEmail = exports.busResetPassword = exports.busForgotPassword = exports.busSignup = void 0;
                    ...
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 3:
                        ...
                        if (res.data.status === 'success') {
                          (0, _alert.showAlert)(
                            'success',
                            'Successfully! Check Your email Address '.concat(
                              businessEmail,
                              ' for Instruction'
                            )
                          );
                  ...
                  while (1) {
                    switch ((_context3.prev = _context3.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'POST',
                          url: '/api/v1/businessUsers/resetPassword/'.concat(
                            _index.busToken
                          ),
                          data: {
                            businessPassword: businessPassword,
                  ...
                  while (1) {
                    switch ((_context4.prev = _context4.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/businessUsers/sendverifyemail/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                      ...
                      case 7:
                        ...
                        (0, _alert.showAlert)(
                          'error',
                          'Unable to Send Email. Kindly Retry'
                        );
    ...
    'signup_login.js': [
      function (require, module, exports) {
        ...
        var busSignupInput = function busSignupInput(e) {
          ...
          var businessPhoneNumber = document.getElementById('input-bus-phone')
            .value;
          var businessPassword = document.getElementById('input-bus-password')
            .value;
          (0, _signupAPI.busSignup)(
            businessName,
            businessEmail,
            businessPhoneNumber,
            businessPassword
        ...
        var busLoginInput = function busLoginInput(e) {
          ...
          var busisnessPassword = document.getElementById('pass-bus-login')
            .value;
      ...
      { './signupAPI': 'signupAPI.js', './loginAPI': 'loginAPI.js' },
    ],
    'forgot_resetPass.js': [
      function (require, module, exports) {
        'use strict';
        ...
        var busResetPassInput = function busResetPassInput(e) {
          e.preventDefault();
          var businessPassword = document.getElementById('reset-bus-password')
            .value;
                  ...
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/salestoday/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                      ...
                      case 3:
                        ...
                        if (res.data.status === 'success') {
                          ...
                          _index.sumOfSalesResult.innerHTML = '\u20A6 '.concat(
                            todayResult
                          );
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/salesWeek/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                  ...
                  while (1) {
                    switch ((_context3.prev = _context3.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/salesmonth/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                  ...
                  while (1) {
                    switch ((_context4.prev = _context4.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/saleslifetime/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                  ...
                  while (1) {
                    switch ((_context5.prev = _context5.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/transtoday/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                      ...
                      case 3:
                        ...
                        if (res.data.status === 'success') {
                          ...
                          _index.sumOfTransResult.innerHTML = '\u20A6 '.concat(
                            transTodayResult
                          );
                  ...
                  while (1) {
                    switch ((_context6.prev = _context6.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/transweek/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                  ...
                  while (1) {
                    switch ((_context7.prev = _context7.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/transmonth/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                  ...
                  while (1) {
                    switch ((_context8.prev = _context8.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'GET',
                          url: '/api/v1/orders/translifetime/'.concat(
                            _index.salesTransBusinessUserID
                          ),
                        });
                      ...
                      case 3:
                        ...
                        if (res.data.status === 'success') {
                          transLifeTimeResult =
                            res.data.data.sumOfTransLifeTime;
                          _index.sumOfTransResult.innerHTML = '\u20A6 '.concat(
                            transLifeTimeResult
                          );
                          (0, _index.hideTransLoading)();
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var busToken = (document.getElementById('forgotBusPassToken') || {})
          .value;
        exports.busToken = busToken;
        var salesTransBusinessUserID = (
        ...
        var business_pixel_Form = document.getElementById(
          'business-pixel-form'
        );
        ...
        var request_Verify_Email_btn = document.getElementById(
          'request-verify-email_btn'
        );
        if (request_Verify_Email_btn)
          request_Verify_Email_btn.addEventListener('click', function () {
        ...
        if (salesToday_btn)
          salesToday_btn.addEventListener('click', function () {
            displaySalesLoading(), (0, _salesTransAPI.salesToday)();
          });
        if (salesWeekly_btn)
          salesWeekly_btn.addEventListener('click', function () {
            displaySalesLoading(), (0, _salesTransAPI.salesThisWeek)();
          });
        if (salesMonthly_btn)
          salesMonthly_btn.addEventListener('click', function () {
            displaySalesLoading(), (0, _salesTransAPI.salesThisMonth)();
          });
        if (salesLifeTime_btn)
          salesLifeTime_btn.addEventListener('click', function () {
        ...
        if (transToday_btn)
          transToday_btn.addEventListener('click', function () {
            displayTransLoading(), (0, _salesTransAPI.transToday)();
          });
        if (transWeekly_btn)
          transWeekly_btn.addEventListener('click', function () {
            displayTransLoading(), (0, _salesTransAPI.transThisWeek)();
          });
        if (transMonthly_btn)
          transMonthly_btn.addEventListener('click', function () {
            displayTransLoading(), (0, _salesTransAPI.transThisMonth)();
          });
        if (transLifeTime_btn)
          transLifeTime_btn.addEventListener('click', function () {
            displayTransLoading(), (0, _salesTransAPI.transLifeTime)();
          });
        if (busloginForm)
          busloginForm.addEventListener('submit', _signup_login.busLoginInput);
        if (logoutBus) logoutBus.addEventListener('click', _loginAPI.busLogout);
        if (busSignupForm)
          busSignupForm.addEventListener(
            'submit',
            _signup_login.busSignupInput
          );
        if (busForgotForm)
          busForgotForm.addEventListener(
            'submit',
            _forgot_resetPass.busForgotPassInput
          );
        if (resetBusPassForm)
          resetBusPassForm.addEventListener(
            'submit',
            _forgot_resetPass.busResetPassInput
          );
        if (createProductForm)
          createProductForm.addEventListener(
            'submit',
            _product.createProductInput
          );
        if (editProductForm)
          editProductForm.addEventListener('submit', _product.editProductInput);
        if (business_pixel_Form)
          business_pixel_Form.addEventListener('submit', function (e) {
            e.preventDefault();
            var facebookPixelId = document.getElementById('bussiness-pixelId')
              .value;
            var facebookPixelCurrency = document.getElementById(
              'bussiness-pixel-currency'
            ).value;
            var facebookPixelValue = document.getElementById(
              'bussiness-pixel-value'
            ).value;
            (0,
            _update.updatePixel)(facebookPixelId, facebookPixelCurrency, facebookPixelValue);
          });
        if (tagsForm)
        ...
        if (updateFormmobile)
          updateFormmobile.addEventListener('submit', function (e) {
            e.preventDefault();
            var orders = document.getElementById('ordersemail').value;
            (0, _update.updateOrderEmails)(orders);
          });
        if (updateShipingForm)
          updateShipingForm.addEventListener('submit', function (e) {
            e.preventDefault();
            var OrderId = document.getElementById('OrderId').value;
            var logisticName = document.getElementById('logName').value;
            var trackingNum = document.getElementById('logNum').value;
            (0,
            _update.updateShippingOrder)(OrderId, logisticName, trackingNum);
          });
        ...
        if (selectPriceOptions) {
          ...
          var promoQtyPriceValue = document.getElementById('inputPromoQtyPrice')
            .value; // console.log(promoQtyPriceValue);
      ...
      },
      {
        ...
        './update': 'update.js',
        './alert': 'alert.js',
        './signup_login': 'signup_login.js',
        './forgot_resetPass': 'forgot_resetPass.js',
        './salesTransAPI': 'salesTransAPI.js',
      },
    ],
