...
exports.updateSchedule = exports.updateDelivery = exports.updateProduct = exports.cloneProductApi = exports.updateStatusOrder = exports.updateShippingOrder = exports.updateOrderEmails = exports.updateTags = exports.updatePixel = void 0;
...
var updateStatusOrder = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(OrderId, status, target) {
    var res, tda, icon, st;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/orders/status/".concat(OrderId),
              data: {
                status: status
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Order has been marked as ".concat(status));
              ...
              if (status.split(/\W+/).length === 2) {
                st = status.replace(' ', '_');
                icon.classList.add("".concat(st, "_order_icon"));
              } else {
                icon.classList.add("".concat(status, "_order_icon"));
              }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Opps! Unable to update order. Try again later. If the error persist, kindly contact us ASAP');
            if (_context5.t0.response) console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context5.t0.response.data.message));else console.log(_context5.t0);
  ...
  return function updateStatusOrder(_x12, _x13, _x14) {
...
var cloneProductApi = /*#__PURE__*/function () {
  ...
  return function cloneProductApi(_x15) {
...
var updateProduct = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(productName, price, stock, additionalInfo, delInfo, discount, colours, sizes, promoQtyPrice, FbId, currency, value, conversionEvent, thankYouPage, submitBtnText, submitBtnBGColor, submitBtnColor, productId, submitButton) {
  ...
  return function updateProduct(_x16, _x17, _x18, _x19, _x20, _x21, _x22, _x23, _x24, _x25, _x26, _x27, _x28, _x29, _x30, _x31, _x32, _x33, _x34) {
...
var updateDelivery = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(DelOrderId) {
    var res;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Opps! Unable to update order. Try again later. If the error persist, kindly contact us ASAP');
            console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context8.t0.response.data.message));
  ...
  return function updateDelivery(_x35) {
...
var updateSchedule = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(schOrderId, scheduledAt, submitButton, target) {
    var res, tda, icon;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 7:
            ...
            (0, _index.stopLoadingBtnSpinner)(submitButton);
            (0, _alert.showAlert)('error', 'Opps! Unable to update order. Try again later. If the error persist, kindly contact us ASAP');
            if (_context9.t0.response) console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context9.t0.response.data.message));else console.log(_context9.t0);
  ...
  return function updateSchedule(_x36, _x37, _x38, _x39) {
...
$('.change-order-status').on('click', function (e) {
  ...
  if (confirm("Are you sure you want ".concat(orderName, "'s order ").concat(status, "? Click Ok to confirm"))) {
    (0, _alert.showAlert)('success', 'Processing...');
    (0, _update.updateStatusOrder)(orderId, status, target);
  } else {
    return false;
  }
});
