...
var createProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productName, price, stock, additionalInfo, discount, codOption, colours, sizes, promoQtyPrice, facebookPixelId, facebookCurrency, facebookValue, submitButton) {
  ...
  return function createProduct(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13) {
...
exports.updateSchedule = exports.updateDelivery = exports.updateProduct = exports.updateCancelOrder = exports.updateShippingOrder = exports.updateOrderEmails = exports.updateTags = exports.updatePixel = void 0;
...
var updateProduct = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(productName, price, stock, additionalInfo, discount, codOption, colours, sizes, promoQtyPrice, promoPriceQty, facebookPixelId, facebookCurrency, facebookValue, productId, submitButton) {
  ...
  return function updateProduct(_x13, _x14, _x15, _x16, _x17, _x18, _x19, _x20, _x21, _x22, _x23, _x24, _x25, _x26, _x27) {
...
var updateDelivery = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(DelOrderId) {
    var res;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Opps! Unable to update order. Try again later. If the error persist, kindly contact us ASAP');
            console.log("\uD83D\uDD25\uD83D\uDD25\uD83D\uDD25 ".concat(_context7.t0.response.data.message));
  ...
  return function updateDelivery(_x28) {
...
var updateSchedule = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(schOrderId, scheduledAt) {
    var res;
  ...
  return function updateSchedule(_x29, _x30) {
...
var createProductInput = function createProductInput(e) {
  ...
  var codOptionCheckbox = document.getElementById('cod_Check_Option');
  ...
  (0, _create.createProduct)(productName, price, stock, additionalInfo, discount, codOption, colours, sizes, promoPriceQty, facebookPixelId, facebookCurrency, facebookValue, submitButton);
};
...
var editProductInput = function editProductInput(e) {
  ...
  var editCodOptionCheckbox = document.getElementById('edit_cod_Check_Option');
  ...
  (0, _update.updateProduct)(productName, editprice, stock, additionalInfo, discount, editCodOption, colours, sizes, promoPriceQty, promoPriceQty, facebookPixelId, facebookCurrency, facebookValue, productId, submitButton);
};
...
var addNewbusInput = function addNewbusInput(e) {
  e.preventDefault();
  var submitButton = e.submitter;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","./index":"index.js"}],"../../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
var global = arguments[3];
//! moment.js
//! version : 2.29.1
...
if (addNewBusForm) addNewBusForm.addEventListener('submit', _signup_login.addNewbusInput);
...
$('.create-tags-pencil').on('click', function (e) {
  ...
  var orderId = target.id;
  var allOrdersTagsForm = document.getElementById("order-form-tags-".concat(orderId));
  allOrdersTagsForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var tags = document.getElementById("input-order-tags-".concat(orderId)).value;
    var submitButton = e.submitter;
    loadingBtnSpinner(submitButton);
    (0, _update.updateTags)(tags, orderId, submitButton);
  });
